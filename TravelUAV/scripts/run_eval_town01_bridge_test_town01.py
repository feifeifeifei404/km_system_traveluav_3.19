...
env.setdefault("EVAL_SAVE_DIR", os.path.join(root_dir, "result", "eval_closeloop", "eval_town10HD"))

cmd = [
    sys.executable,
    os.path.join(root_dir, "src", "vlnce_src", "eval.py"),
    "--run_type", "eval",
    "--name", "TravelLLM_Town10HD_Bridge_Test",
    ...
    "--eval_save_path", os.path.join(root_dir, "result", "eval_closeloop", "eval_town10HD"),
    ...
    "--eval_json_path", os.path.join(root_dir, "Dataset", "dataset_split", "data", "uav_dataset", "all_cases_town10HD_seen_valset.json"),
...
print("[INFO] Running all Town10HD tasks from seen_valset")
print("[INFO] Eval JSON:", os.path.join(root_dir, "Dataset", "dataset_split", "data", "uav_dataset", "all_cases_town10HD_seen_valset.json"))
